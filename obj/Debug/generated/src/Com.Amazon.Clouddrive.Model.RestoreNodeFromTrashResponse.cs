...
namespace Com.Amazon.Clouddrive.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RestoreNodeFromTrashResponse']"
	[global::Android.Runtime.Register ("com/amazon/clouddrive/model/RestoreNodeFromTrashResponse", DoNotGenerateAcw=true)]
	public partial class RestoreNodeFromTrashResponse : global::Com.Amazon.Clouddrive.Model.Node {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/clouddrive/model/RestoreNodeFromTrashResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RestoreNodeFromTrashResponse); }
		}

		protected RestoreNodeFromTrashResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RestoreNodeFromTrashResponse']/constructor[@name='RestoreNodeFromTrashResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe RestoreNodeFromTrashResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (RestoreNodeFromTrashResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Clouddrive.Model.RestoreNodeFromTrashResponse __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Clouddrive.Model.RestoreNodeFromTrashResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Location {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RestoreNodeFromTrashResponse']/method[@name='getLocation' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RestoreNodeFromTrashResponse']/method[@name='setLocation' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
