...
namespace Com.Amazon.Clouddrive.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='CreateNodeResponse']"
	[global::Android.Runtime.Register ("com/amazon/clouddrive/model/CreateNodeResponse", DoNotGenerateAcw=true)]
	public partial class CreateNodeResponse : global::Com.Amazon.Clouddrive.Model.Node {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/clouddrive/model/CreateNodeResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (CreateNodeResponse); }
		}

		protected CreateNodeResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='CreateNodeResponse']/constructor[@name='CreateNodeResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe CreateNodeResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (CreateNodeResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Clouddrive.Model.CreateNodeResponse __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Clouddrive.Model.CreateNodeResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Location {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='CreateNodeResponse']/method[@name='getLocation' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='CreateNodeResponse']/method[@name='setLocation' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
