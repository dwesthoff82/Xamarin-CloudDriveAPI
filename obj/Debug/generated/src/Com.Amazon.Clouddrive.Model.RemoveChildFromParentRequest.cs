...
namespace Com.Amazon.Clouddrive.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']"
	[global::Android.Runtime.Register ("com/amazon/clouddrive/model/RemoveChildFromParentRequest", DoNotGenerateAcw=true)]
	public partial class RemoveChildFromParentRequest : global::Java.Lang.Object, global::Com.Amazon.Clouddrive.Model.ICloudDriveRequest {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/clouddrive/model/RemoveChildFromParentRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RemoveChildFromParentRequest); }
		}

		protected RemoveChildFromParentRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']/constructor[@name='RemoveChildFromParentRequest' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe RemoveChildFromParentRequest (string p0, string p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (RemoveChildFromParentRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Clouddrive.Model.RemoveChildFromParentRequest __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Clouddrive.Model.RemoveChildFromParentRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string ChildId {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']/method[@name='getChildId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']/method[@name='setChildId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string ParentId {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']/method[@name='getParentId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']/method[@name='setParentId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='RemoveChildFromParentRequest']/method[@name='compareTo' and count(parameter)=1 and parameter[1][@type='com.amazon.clouddrive.model.CloudDriveRequest']]"
