...
namespace Com.Amazon.Clouddrive.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']"
	[global::Android.Runtime.Register ("com/amazon/clouddrive/model/EditableNode", DoNotGenerateAcw=true)]
	public partial class EditableNode : global::Java.Lang.Object, global::Com.Amazon.Clouddrive.Model.IEditableNode, global::Java.Lang.IComparable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/clouddrive/model/EditableNode", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (EditableNode); }
		}

		protected EditableNode (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/constructor[@name='EditableNode' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe EditableNode ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (EditableNode)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Amazon.Clouddrive.Model.ContentProperties ContentProperties {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getContentProperties' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setContentProperties' and count(parameter)=1 and parameter[1][@type='com.amazon.clouddrive.model.ContentProperties']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Description {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getDescription' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setDescription' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Id {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Kind {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getKind' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setKind' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<string> Labels {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getLabels' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setLabels' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;java.lang.String&gt;']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getName' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setName' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<string> Parents {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getParents' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setParents' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;java.lang.String&gt;']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IDictionary<string, global::System.Collections.Generic.IDictionary<string, string>> Properties {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getProperties' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setProperties' and count(parameter)=1 and parameter[1][@type='java.util.Map&lt;java.lang.String, java.util.Map&lt;java.lang.String, java.lang.String&gt;&gt;']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Status {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='getStatus' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='setStatus' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		static Delegate cb_compareTo_Lcom_amazon_clouddrive_model_EditableNode_;
#pragma warning disable 0169
		static Delegate GetCompareTo_Lcom_amazon_clouddrive_model_EditableNode_Handler ()
		{
			if (cb_compareTo_Lcom_amazon_clouddrive_model_EditableNode_ == null)
				cb_compareTo_Lcom_amazon_clouddrive_model_EditableNode_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, int>) n_CompareTo_Lcom_amazon_clouddrive_model_EditableNode_);
			return cb_compareTo_Lcom_amazon_clouddrive_model_EditableNode_;
		}

		static int n_CompareTo_Lcom_amazon_clouddrive_model_EditableNode_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Amazon.Clouddrive.Model.EditableNode __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Clouddrive.Model.EditableNode> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Com.Amazon.Clouddrive.Model.EditableNode p0 = global::Java.Lang.Object.GetObject<global::Com.Amazon.Clouddrive.Model.EditableNode> (native_p0, JniHandleOwnership.DoNotTransfer);
			int __ret = __this.CompareTo (p0);
			return __ret;
		}
#pragma warning restore 0169

		static IntPtr id_compareTo_Lcom_amazon_clouddrive_model_EditableNode_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='EditableNode']/method[@name='compareTo' and count(parameter)=1 and parameter[1][@type='com.amazon.clouddrive.model.EditableNode']]"
		[Register ("compareTo", "(Lcom/amazon/clouddrive/model/EditableNode;)I", "GetCompareTo_Lcom_amazon_clouddrive_model_EditableNode_Handler")]
		public virtual unsafe int CompareTo (global::Com.Amazon.Clouddrive.Model.EditableNode p0)
		{
			if (id_compareTo_Lcom_amazon_clouddrive_model_EditableNode_ == IntPtr.Zero)
				id_compareTo_Lcom_amazon_clouddrive_model_EditableNode_ = JNIEnv.GetMethodID (class_ref, "compareTo", "(Lcom/amazon/clouddrive/model/EditableNode;)I");
			try {
				JValue* __args = stackalloc JValue [1];
				...
				int __ret;
				if (GetType () == ThresholdType)
					__ret = JNIEnv.CallIntMethod  (Handle, id_compareTo_Lcom_amazon_clouddrive_model_EditableNode_, __args);
				else
					__ret = JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "compareTo", "(Lcom/amazon/clouddrive/model/EditableNode;)I"), __args);
				return __ret;
			} finally {
			}
		}
