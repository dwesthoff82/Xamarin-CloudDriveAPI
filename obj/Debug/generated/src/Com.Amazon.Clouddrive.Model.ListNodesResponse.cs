...
namespace Com.Amazon.Clouddrive.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='ListNodesResponse']"
	[global::Android.Runtime.Register ("com/amazon/clouddrive/model/ListNodesResponse", DoNotGenerateAcw=true)]
	public partial class ListNodesResponse : global::Com.Amazon.Clouddrive.Model.PaginatedCloudDriveResponse, global::Com.Amazon.Clouddrive.Model.INodeListingResponse {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/clouddrive/model/ListNodesResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ListNodesResponse); }
		}

		protected ListNodesResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='ListNodesResponse']/constructor[@name='ListNodesResponse' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ListNodesResponse ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ListNodesResponse)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Clouddrive.Model.ListNodesResponse __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Clouddrive.Model.ListNodesResponse> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return global::Android.Runtime.JavaList<global::Com.Amazon.Clouddrive.Model.Node>.ToLocalJniHandle (__this._getData ());
		}
#pragma warning restore 0169

		static IntPtr id_getData;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='ListNodesResponse']/method[@name='getData' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.clouddrive.model']/class[@name='ListNodesResponse']/method[@name='setData' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;com.amazon.clouddrive.model.Node&gt;']]"
